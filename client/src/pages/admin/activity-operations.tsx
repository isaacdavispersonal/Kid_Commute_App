...
export default function ActivityOperationsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold mb-1" data-testid="heading-activity-operations">
          Activity & Operations
        </h1>
        <p className="text-sm text-muted-foreground">
          Monitor fleet health, manage driver utilities, review audit logs, and track time management
        </p>
      </div>

      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="route-health" className="flex items-center gap-2" data-testid="tab-route-health">
            <Activity className="w-4 h-4" />
            <span className="hidden sm:inline">Route Health</span>
            <span className="sm:hidden">Health</span>
          </TabsTrigger>
          <TabsTrigger value="driver-utilities" className="flex items-center gap-2" data-testid="tab-driver-utilities">
          ...
          <TabsTrigger value="time-management" className="flex items-center gap-2" data-testid="tab-time-management">
        ...
        <TabsContent value="route-health" className="mt-6">
          <RouteHealthSection />
        </TabsContent>

        <TabsContent value="driver-utilities" className="mt-6">
