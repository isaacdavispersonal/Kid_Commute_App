...
export default function AdminRouteHealthPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold mb-1" data-testid="heading-route-health">Route Health Monitor</h1>
        <p className="text-sm text-muted-foreground">
          Real-time overview of route status, driver availability, and incidents
        </p>
      </div>
